...
public class ICD10CodesManipulator {
    ...
    // public ArrayList<ICDNode> getChapterList(){ 
    //     return chapterList;
    // }
...
//            Resource fileResource = applicationContext.getResource("icd_10_v2019.xml");
...
//            br
            ...
            document = builder.parse(getClass().getResourceAsStream("sql/icd_10_v2019.xml"));
        } catch (Exception e){
