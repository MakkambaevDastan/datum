...
public interface UserMapper {
    ...
    default String encryptPassword(String password) {
        if (password==null) throw new ExceptionApp(401, "Введите пароль");
        if (password.equals("") || password.equals(" ")) throw new ExceptionApp(401,"Пароль не может быть пустым");
        if (password.contains(" ")) throw new ExceptionApp(401,"Пароль содержить пробел");
